	...
	for angle in [2/9, 1/6, 1/9, 1/18]
		for R in [80, 120, 150, 160, 180, 200]
			for rr in [20, 22, 25, 30, 40, 60, 80, 100]
				...
				push!(Area, A)
				push!(tauM, 1/(γ/(6μ)*0.0379*(π*angle)^3/(sinpi(angle))*sqrt(π*angle - sinpi(2*angle)/2)/sqrt(A)))
				push!(sigmaM, γ/(6μ)*0.0379*(π*angle)^3/(sinpi(angle))*sqrt(π*angle - sinpi(2*angle)/2)/sqrt(A))
			end
		end
	end
...
data = [
	...
	(180, 22, 0.0,    2024, 2, 29, 13, 18, 40), 	# 26 
	(180, 25, 0.0,    2024, 2, 29, 14, 39, 40), 	# 27
	(180, 30, 0.0,    2024, 2, 29, 16, 0,  40), 	# 28
	(180, 40, 0.0,    2023, 11, 3, 23, 34, 40), 	# 29
	(180, 80, 0.0,    2023, 11, 4, 1,  1,  40), 	# 30
	(200, 20, 0.0,    2023, 11, 4, 2,  27, 40), 	# 31
	(200, 40, 0.0,    2023, 11, 4, 3,  54, 40), 	# 32
	(200, 80, 0.0,    2023, 11, 4, 5,  20, 40), 	# 33
	(150, 20, 1.0e-6, 2023, 11, 4, 6,  46, 40), 	# 34  
	(150, 40, 1.0e-6, 2023, 11, 4, 8,  11, 40), 	# 35
	(150, 80, 1.0e-6, 2023, 11, 4, 9,  37, 40), 	# 36
	(180, 20, 1.0e-6, 2023, 11, 4, 11, 3,  40), 	# 37
	(180, 40, 1.0e-6, 2023, 11, 4, 12, 30, 40), 	# 38
	(180, 80, 1.0e-6, 2023, 11, 4, 13, 58, 40), 	# 39
	(200, 20, 1.0e-6, 2023, 11, 4, 15, 26, 40), 	# 40
	(200, 40, 1.0e-6, 2023, 11, 4, 16, 54, 40), 	# 41
	(200, 80, 1.0e-6, 2023, 11, 4, 18, 21, 40), 	# 42
	(150, 20, 0.0,    2023, 11, 4, 19, 46, 30), 	# 43
	(150, 40, 0.0,    2023, 11, 4, 21, 11, 30), 	# 44
	(150, 80, 0.0,    2023, 11, 4, 22, 36, 30), 	# 45
	(180, 20, 0.0,    2023, 11, 5, 0,  2,  30), 	# 46
	(180, 40, 0.0,    2023, 11, 5, 1,  28, 30), 	# 47
	(180, 80, 0.0,    2023, 11, 5, 2,  56, 30), 	# 48
	(200, 20, 0.0,    2023, 11, 5, 4,  24, 30), 	# 49
	(200, 40, 0.0,    2023, 11, 5, 5,  51, 30), 	# 50
	(200, 80, 0.0,    2023, 11, 5, 7,  19, 30), 	# 51
	(150, 20, 1.0e-6, 2023, 11, 5, 8,  47, 30), 	# 52
	(150, 40, 1.0e-6, 2023, 11, 5, 10, 14, 30), 	# 53
	(150, 80, 1.0e-6, 2023, 11, 5, 11, 42, 30), 	# 54
	(180, 20, 1.0e-6, 2023, 11, 5, 13, 10, 30), 	# 55
	(180, 40, 1.0e-6, 2023, 11, 5, 14, 38, 30), 	# 56
	(180, 80, 1.0e-6, 2023, 11, 5, 16, 7,  30), 	# 57
	(200, 20, 1.0e-6, 2023, 11, 5, 17, 35, 30), 	# 58
	(200, 40, 1.0e-6, 2023, 11, 5, 19, 3,  30), 	# 59
	(200, 80, 1.0e-6, 2023, 11, 5, 20, 30, 30), 	# 60
	(150, 20, 0.0,    2023, 11, 5, 21, 58, 10), 	# 61
	(150, 40, 0.0,    2023, 11, 5, 23, 26, 10), 	# 62
	(150, 80, 0.0,    2023, 11, 6, 0,  54, 10), 	# 63
	(180, 20, 0.0,    2023, 11, 6, 2,  22, 10), 	# 64
	(180, 40, 0.0,    2023, 11, 6, 3,  50, 10), 	# 65
	(180, 80, 0.0,    2023, 11, 6, 5,  17, 10), 	# 66
	(200, 20, 0.0,    2023, 11, 6, 6,  45, 10), 	# 67
	(200, 40, 0.0,    2023, 11, 6, 8,  13, 10), 	# 68
	(200, 80, 0.0,    2023, 11, 6, 9,  40, 10), 	# 69
	(150, 20, 1.0e-6, 2023, 11, 6, 11, 7,  10), 	# 70
	(150, 40, 1.0e-6, 2023, 11, 6, 12, 32, 10), 	# 71
	(150, 80, 1.0e-6, 2023, 11, 6, 13, 58, 10), 	# 72
	(180, 20, 1.0e-6, 2023, 11, 6, 15, 24, 10), 	# 73
	(180, 40, 1.0e-6, 2023, 11, 6, 16, 51, 10), 	# 74
	(180, 80, 1.0e-6, 2023, 11, 6, 18, 17, 10), 	# 75
	(200, 20, 1.0e-6, 2023, 11, 6, 19, 42, 10), 	# 76
	(200, 40, 1.0e-6, 2023, 11, 6, 21, 7,  10), 	# 77
	(200, 80, 1.0e-6, 2023, 11, 6, 22, 32, 10), 	# 78
]

data_arrested = [
	(160, 20, 0.0,    2023, 11,24, 13, 24, 40), 	# 1
	(160, 30, 0.0,    2024,  3,21, 19, 27, 40), 	# 2
	(160, 40, 0.0,    2024,  3,21, 15, 23, 40), 	# 3
	(180, 20, 0.0,    2024,  3,21, 23, 32, 40), 	# 4
	(180, 30, 0.0,    2024,  3,22,  3, 37, 40), 	# 5
	(180, 40, 0.0,    2024,  3,22,  7, 40, 40), 	# 6
	(200, 20, 0.0,    2023, 11,24, 21, 41, 40), 	# 7
	(200, 30, 0.0,    2023, 11,24, 23,  5, 40), 	# 8
	(200, 40, 0.0,    2024,  3,22, 11, 37, 40), 	# 9
	(160, 20, 1.0e-6, 2023, 11,25,  1, 51, 40), 	# 10
	(160, 30, 1.0e-6, 2023, 11,25,  3, 14, 40), 	# 11
	(160, 40, 1.0e-6, 2023, 11,25,  4, 37, 40), 	# 12
	(180, 20, 1.0e-6, 2023, 11,25,  6,  0, 40), 	# 13
	(180, 30, 1.0e-6, 2023, 11,25,  7, 23, 40), 	# 14
	(180, 40, 1.0e-6, 2023, 11,25,  8, 47, 40), 	# 15
	(200, 20, 1.0e-6, 2023, 11,25, 10, 10, 40), 	# 16
	(200, 30, 1.0e-6, 2023, 11,25, 11, 33, 40), 	# 17
	(200, 40, 1.0e-6, 2023, 11,25, 12, 56, 40), 	# 18
	(160, 20, 0.0,    2023, 11,25, 14, 19, 30), 	# 19
	(160, 30, 0.0,    2023, 11,25, 15, 42, 30), 	# 20
	(160, 40, 0.0,    2024,  3,22, 15, 25, 30), 	# 21
	(160, 60, 0.0,    2024,  3,22, 19, 22, 30), 	# 22
	(160, 80, 0.0,    2023, 12,23,  1, 53, 30), 	# 23
	(160, 100,0.0,    2023, 12,23,  3, 13, 30), 	# 24
	(180, 20, 0.0,    2023, 11,25, 18, 27, 30), 	# 25
	(180, 30, 0.0,    2023, 11,25, 19, 48, 30), 	# 26
	(180, 40, 0.0,    2023, 11,25, 21,  7, 30), 	# 27
	(180, 60, 0.0,    2024,  3,22, 23, 22, 30), 	# 28
	(180, 80, 0.0,    2024,  4,27, 11, 34, 30), 	# 29
	(180, 100,0.0,    2024,  4,27, 15, 36, 30), 	# 30
	(200, 20, 0.0,    2023, 11,25, 22, 23, 30), 	# 31
	(200, 30, 0.0,    2023, 11,25, 23, 40, 30), 	# 32
	(200, 40, 0.0,    2024,  3,23,  3, 27, 30), 	# 33
	(200, 60, 0.0,    2024,  3,23,  7, 31, 30), 	# 34
	(200, 80, 0.0,    2023, 12,23,  9, 57, 30), 	# 35 
	(200, 100,0.0,    2023, 12,23, 11, 19, 30), 	# 36
	(160, 20, 1.0e-6, 2023, 11,26,  2, 24, 30), 	# 37
	(160, 30, 1.0e-6, 2023, 11,26,  3, 45, 30), 	# 38
	(160, 40, 1.0e-6, 2023, 11,26,  5,  7, 30), 	# 39
	(180, 20, 1.0e-6, 2023, 11,26,  6, 28, 30), 	# 40
	(180, 30, 1.0e-6, 2023, 11,26,  7, 50, 30), 	# 41
	(180, 40, 1.0e-6, 2023, 11,26,  9, 12, 30), 	# 42 
	(200, 20, 1.0e-6, 2023, 11,26, 10, 33, 30), 	# 43
	(200, 30, 1.0e-6, 2023, 11,26, 11, 55, 30), 	# 44
	(200, 40, 1.0e-6, 2023, 11,26, 13, 16, 30), 	# 45
	(160, 20, 0.0,    2023, 11,27, 14, 51, 20), 	# 46
	(160, 30, 0.0,    2023, 11,27, 16, 12, 20), 	# 47
	(160, 40, 0.0,    2023, 11,27, 17, 33, 20), 	# 48
	(160, 60, 0.0,    2024,  3,23, 11, 35, 20), 	# 49
	(160, 80, 0.0,    2023, 12,22, 13, 44, 20), 	# 50
	(160, 100,0.0,    2023, 12,22, 15,  5, 20), 	# 51
	(180, 20, 0.0,    2023, 11,27, 18, 54, 20), 	# 52
	(180, 30, 0.0,    2023, 11,27, 20, 15, 20), 	# 53
	(180, 40, 0.0,    2023, 11,27, 21, 36, 20), 	# 54
	(180, 60, 0.0,    2024,  3,23, 15, 37, 20), 	# 55
	(180, 80, 0.0,    2024,  4,27,  3, 27, 20), 	# 56
	(180,100, 0.0,    2024,  4,27,  7, 29, 20), 	# 57
	(200, 20, 0.0,    2023, 11,27, 22, 57, 20), 	# 58
	(200, 30, 0.0,    2023, 11,28,  0, 18, 20), 	# 59
	(200, 40, 0.0,    2023, 11,28,  1, 39, 20), 	# 60
	(200, 60, 0.0,    2024,  3,23, 19, 17, 20), 	# 61
	(200, 80, 0.0,    2023, 12,22, 21, 50, 20), 	# 62
	(200,100, 0.0,    2023, 12,22, 23, 11, 20), 	# 63
	(160, 20, 1.0e-6, 2023, 11,28,  3,  0, 20), 	# 64
	(160, 30, 1.0e-6, 2023, 11,28,  4, 22, 20), 	# 65
	(160, 40, 1.0e-6, 2023, 11,28,  5, 42, 20), 	# 66
	(180, 20, 1.0e-6, 2023, 11,28,  7,  3, 20), 	# 67
	(180, 30, 1.0e-6, 2023, 11,28,  8, 24, 20), 	# 68
	(180, 40, 1.0e-6, 2023, 11,28,  9, 45, 20), 	# 69
	(200, 20, 1.0e-6, 2023, 11,28, 11,  6, 20), 	# 70
	(200, 30, 1.0e-6, 2023, 11,28, 12, 27, 20), 	# 71
	(200, 40, 1.0e-6, 2023, 11,28, 13, 47, 20), 	# 72
	(160, 20, 0.0,    2023, 11,26, 14, 38, 10), 	# 73
	(160, 30, 0.0,    2023, 11,26, 15, 59, 10), 	# 74
	(160, 40, 0.0,    2023, 11,26, 17, 21, 10), 	# 75
	(160, 60, 0.0,    2024,  3,23, 23, 15, 10), 	# 76
	(160, 80, 0.0,    2023, 12,23, 14,  1, 10), 	# 77
	(160, 100,0.0,    2023, 12,23, 15, 22, 10), 	# 78
	(180, 20, 0.0,    2023, 11,26, 18, 42, 10), 	# 79
	(180, 30, 0.0,    2023, 11,26, 20,  3, 10), 	# 80
	(180, 40, 0.0,    2023, 11,26, 21, 24, 10), 	# 81
	(180, 60, 0.0,    2024,  3,24,  3, 16, 10), 	# 82
	(180, 80, 0.0,    2024,  4,26, 19, 26, 10), 	# 83
	(180, 100,0.0,    2024,  4,26, 23, 24, 10), 	# 84
	(200, 20, 0.0,    2023, 11,26, 22, 45, 10), 	# 85
	(200, 30, 0.0,    2023, 11,27,  0,  5, 10), 	# 86
	(200, 40, 0.0,    2023, 11,27,  1, 26, 10), 	# 87
	(200, 60, 0.0,    2024,  3,24,  7, 21, 10), 	# 88
	(200, 80, 0.0,    2023, 12,23, 21, 51, 10), 	# 89
	(200, 100,0.0,    2023, 12,23, 23, 10, 10), 	# 90
	(160, 20, 1.0e-6, 2023, 11,27,  2, 47, 10), 	# 91
	(160, 30, 1.0e-6, 2023, 11,27,  4,  8, 10), 	# 92
	(160, 40, 1.0e-6, 2023, 11,27,  5, 25, 10), 	# 93
	(180, 20, 1.0e-6, 2023, 11,27,  6, 39, 10), 	# 94
	(180, 30, 1.0e-6, 2023, 11,27,  7, 56, 10), 	# 95
	(180, 40, 1.0e-6, 2023, 11,27,  9, 17, 10), 	# 96
	(200, 20, 1.0e-6, 2023, 11,27, 10, 38, 10), 	# 97
	(200, 30, 1.0e-6, 2023, 11,27, 11, 59, 10), 	# 98
	(200, 40, 1.0e-6, 2023, 11,27, 13, 20, 10), 	# 99
	(180, 80,  0.0, 2024, 4, 27, 19, 38, 40), 		# 100
	(180, 100, 0.0, 2024, 4, 27, 23, 36, 40), 		# 101
]
...
data_gradient = [
	...
	(180, 80, 0.0, 2024, 3,  8, 16, 51, 20, 30, 20)
	(180, 80, 0.0, 2024, 3,  8, 22, 16, 20, 40, 20)
]
