...
data = [
	(80,  40, 0.0,    2023, 11, 1, 19, 6,  20), 	#
	(120, 40, 0.0,    2023, 11, 2, 6,  43, 20), 	#
	(120, 80, 0.0,    2023, 11, 2, 9,  37, 20), 	#
	(150, 20, 0.0,    2023, 11, 2, 13, 0,  20), 	#
	(150, 40, 0.0,    2023, 11, 2, 14, 26, 20), 	#
	(150, 80, 0.0,    2023, 11, 2, 15, 54, 20), 	#
	(180, 20, 0.0,    2023, 11, 2, 17, 23, 20), 	# little smaller little larger
	(180, 40, 0.0,    2023, 11, 2, 18, 49, 20), 	#
	(180, 80, 0.0,    2023, 11, 2, 20, 16, 20), 	#
	(200, 20, 0.0,    2023, 11, 2, 21, 43, 20), 	#
	(200, 40, 0.0,    2023, 11, 2, 23, 8,  20), 	#
	(200, 80, 0.0,    2023, 11, 3, 0,  34, 20), 	#
	(150, 20, 1.0e-6, 2023, 11, 3, 1,  59, 20), 	#
	(150, 40, 1.0e-6, 2023, 11, 3, 3,  25, 20), 	#
	(150, 80, 1.0e-6, 2023, 11, 3, 4,  50, 20), 	#
	(180, 20, 1.0e-6, 2023, 11, 3, 6,  16, 20), 	#
	(180, 40, 1.0e-6, 2023, 11, 3, 7,  41, 20), 	#
	(180, 80, 1.0e-6, 2023, 11, 3, 9,  7,  20), 	#
	(200, 20, 1.0e-6, 2023, 11, 3, 10, 32, 20), 	#
	(200, 40, 1.0e-6, 2023, 11, 3, 15, 17, 20), 	#
	(200, 80, 1.0e-6, 2023, 11, 3, 16, 44, 20), 	#
	(150, 20, 0.0,    2023, 11, 3, 17, 49, 40), 	#
	(150, 40, 0.0,    2023, 11, 3, 19, 13, 40), 	#
	(150, 80, 0.0,    2023, 11, 3, 20, 39, 40), 	#
	(180, 20, 0.0,    2023, 11, 3, 22, 6,  40), 	#
	(180, 40, 0.0,    2023, 11, 3, 23, 34, 40), 	#
	(180, 80, 0.0,    2023, 11, 4, 1,  1,  40), 	#
	(200, 20, 0.0,    2023, 11, 4, 2,  27, 40), 	#
	(200, 40, 0.0,    2023, 11, 4, 3,  54, 40), 	#
	(200, 80, 0.0,    2023, 11, 4, 5,  20, 40), 	#
	(150, 20, 1.0e-6, 2023, 11, 4, 6,  46, 40), 	#
	(150, 40, 1.0e-6, 2023, 11, 4, 8,  11, 40), 	#
	(150, 80, 1.0e-6, 2023, 11, 4, 9,  37, 40), 	#
	(180, 20, 1.0e-6, 2023, 11, 4, 11, 3,  40), 	#
	(180, 40, 1.0e-6, 2023, 11, 4, 12, 30, 40), 	#
	(180, 80, 1.0e-6, 2023, 11, 4, 13, 58, 40), 	#
	(200, 20, 1.0e-6, 2023, 11, 4, 15, 26, 40), 	#
	(200, 40, 1.0e-6, 2023, 11, 4, 16, 54, 40), 	#
	(200, 80, 1.0e-6, 2023, 11, 4, 18, 21, 40), 	#
	(150, 20, 0.0,    2023, 11, 4, 19, 46, 30), 	#
	(150, 40, 0.0,    2023, 11, 4, 21, 11, 30), 	#
	(150, 80, 0.0,    2023, 11, 4, 22, 36, 30), 	#
	(180, 20, 0.0,    2023, 11, 5, 0,  2,  30), 	#
	(180, 40, 0.0,    2023, 11, 5, 1,  28, 30), 	#
	(180, 80, 0.0,    2023, 11, 5, 2,  56, 30), 	#
	(200, 20, 0.0,    2023, 11, 5, 4,  24, 30), 	#
	(200, 40, 0.0,    2023, 11, 5, 5,  51, 30), 	#
	(200, 80, 0.0,    2023, 11, 5, 7,  19, 30), 	#
	(150, 20, 1.0e-6, 2023, 11, 5, 8,  47, 30), 	#
	(150, 40, 1.0e-6, 2023, 11, 5, 10, 14, 30), 	#
	(150, 80, 1.0e-6, 2023, 11, 5, 11, 42, 30), 	#
	(180, 20, 1.0e-6, 2023, 11, 5, 13, 10, 30), 	#
	(180, 40, 1.0e-6, 2023, 11, 5, 14, 38, 30), 	#
	(180, 80, 1.0e-6, 2023, 11, 5, 16, 7,  30), 	#
	(200, 20, 1.0e-6, 2023, 11, 5, 17, 35, 30), 	#
	(200, 40, 1.0e-6, 2023, 11, 5, 19, 3,  30), 	#
	(200, 80, 1.0e-6, 2023, 11, 5, 20, 30, 30), 	#
	(150, 20, 0.0,    2023, 11, 5, 21, 58, 10), 	#
	(150, 40, 0.0,    2023, 11, 5, 23, 26, 10), 	#
	(150, 80, 0.0,    2023, 11, 6, 0,  54, 10), 	#
	(180, 20, 0.0,    2023, 11, 6, 2,  22, 10), 	#
	(180, 40, 0.0,    2023, 11, 6, 3,  50, 10), 	#
	(180, 80, 0.0,    2023, 11, 6, 5,  17, 10), 	#
	(200, 20, 0.0,    2023, 11, 6, 6,  45, 10), 	#
	(200, 40, 0.0,    2023, 11, 6, 8,  13, 10), 	#
	(200, 80, 0.0,    2023, 11, 6, 9,  40, 10), 	#
	(150, 20, 1.0e-6, 2023, 11, 6, 11, 7,  10), 	#
	(150, 40, 1.0e-6, 2023, 11, 6, 12, 32, 10), 	#
	(150, 80, 1.0e-6, 2023, 11, 6, 13, 58, 10), 	#
	(180, 20, 1.0e-6, 2023, 11, 6, 15, 24, 10), 	#
	(180, 40, 1.0e-6, 2023, 11, 6, 16, 51, 10), 	#
	(180, 80, 1.0e-6, 2023, 11, 6, 18, 17, 10), 	#
	(200, 20, 1.0e-6, 2023, 11, 6, 19, 42, 10), 	#
	(200, 40, 1.0e-6, 2023, 11, 6, 21, 7,  10), 	#
	(200, 80, 1.0e-6, 2023, 11, 6, 22, 32, 10), 	#
]
