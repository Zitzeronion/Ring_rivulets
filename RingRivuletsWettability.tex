...
We then consider different kinds of patterning and show that they affect not only the stability but also the morphology.
Thus making it possible to translate breakup states into collapsing ones.} \\%The abstrast goes here instead of the text "The abstract should be..."
...
Here we just give a short introduction into the method and highlight the relevant modeling approximations.
